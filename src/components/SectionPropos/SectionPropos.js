...
export const SectionPropos = ({ pictureIlan, pictureSeb, pictureRemi, ilan, seb, remi, ilanDesc, remiDesc, sebDesc }) => {

    return (
        <StyledSectionPropos>
            <h2>Qui sommes-nous ?</h2>
            <BioItem name={seb} picture={pictureSeb} desc={sebDesc} />
            <BioItem name={ilan} picture={pictureIlan} desc={ilanDesc} />
            <BioItem name={remi} picture={pictureRemi} desc={remiDesc} />
